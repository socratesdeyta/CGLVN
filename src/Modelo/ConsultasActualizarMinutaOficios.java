...
public class ConsultasActualizarMinutaOficios extends Conexion {
...
//    }
    ...
    public boolean Seleccionar(ModeloActualizarMinutaOficios mod, frmActualizarMinutaOficios frm) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection con = getConexion();
        try {
            int filaSeleccionada = frm.jtActMinOfi.getSelectedRow();
            String clave = frm.jtActMinOfi.getValueAt(filaSeleccionada, 0).toString();
...
//    } // fin de metodo eliminar
    ...
    public boolean buscarCaracter(ModeloActualizarMinutaOficios mod, frmActualizarMinutaOficios frm) {
