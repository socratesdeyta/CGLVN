...
public class frmActualizarMinutaOficios extends javax.swing.JFrame {

    public frmActualizarMinutaOficios() {
        initComponents();
        this.setLayout(null);
...
btnAsignarFecha.setVisible(false);
        ...
        jtActMinOfi.setModel(modeloTabla);
        ...
        try {
            ...
            for (int i = 0; i < jtActMinOfi.getColumnCount(); i++) {
                jtActMinOfi.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
            }
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jtActMinOfi = new javax.swing.JTable();
        ...
        jtActMinOfi.setAutoCreateRowSorter(true);
        jtActMinOfi.setFont(new java.awt.Font("Montserrat Light", 0, 12)); // NOI18N
        jtActMinOfi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtActMinOfi.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jtActMinOfi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtActMinOfiMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtActMinOfi);
    ...
    private void jtActMinOfiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtActMinOfiMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jtActMinOfiMouseClicked

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing

        CtrlHome.frmActMinOfi = null;
        //  frmInicio.fun = null;
        // TODO add your handling code here:
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmActualizarMinutaOficios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmActualizarMinutaOficios().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable jtActMinOfi;
