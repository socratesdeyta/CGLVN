...
public class frmFavorito extends javax.swing.JFrame {

    public int idFuncionario = 0;
    public String nombreFuncionario;
    public int id_seccion = 0;
    public int id_serie = 0;
    public int id_serie_a_guardar = 0;
    public int id_subserie = 0;
    public int id_subserie_a_guardar = 0;
    ...
    public frmFavorito(int idFuncionario, String nombreFuncionario, int id_seccion, int id_serie, int id_serie_a_guardar, int id_subserie, int id_subserie_a_guardar, String destinatario, int envio, String titulo, String asunto) {

        this.idFuncionario = idFuncionario;
        this.nombreFuncionario = nombreFuncionario;
        this.id_seccion = id_seccion;
        this.id_serie = id_serie;
        this.id_serie_a_guardar = id_serie_a_guardar;
        this.id_subserie = id_subserie;
        this.id_subserie_a_guardar = id_subserie_a_guardar;
        ...
        //Se llenan los combobox con los datos de los modelos: seccion, serie, subserie
        //Asigna el titulo del Frame con el tipo de registro
        this.setTitle(titulo);

        //Crea un objeto Consulta Favorito
        ConsultasFavorito ConFav = new ConsultasFavorito();

        //Muestra los datos que regresa la consulara mostrarSeccion
        DefaultComboBoxModel modelSecc = new DefaultComboBoxModel(ConFav.mostrarSeccion());
        //Le asigna el modelo y los registros al combobox cbxSeccion
        cbxSeccion.setModel(modelSecc);
        //Asigna el numero que contiene id_seccion al numero que se muestra en el modelo del combobox cbxseccion
        cbxSeccion.setSelectedIndex(this.id_seccion);

        //-------------------------------------------
        //Muestra los datos que regresa la consulara mostrarSerie
        DefaultComboBoxModel modelSer = new DefaultComboBoxModel(ConFav.mostrarSerie(this.id_seccion));
        //Le asigna el modelo y los registros al combobox cbxSerie
        cbxSerie.setModel(modelSer);
        cbxSerie.setVisible(true);
        //Asigna el numero que contiene id_serie al numero que se muestra en el modelo del combobox cbxserie
        cbxSerie.setSelectedIndex(id_serie);
        //this.lblClasificacionAsignada.setText(env.getNombre());
        //Serie ser = (Serie) this.cbxTipoEnvio.getSelectedItem();
        //this.lblClasificacionAsignada.setText();

        //    lblClasificacionAsignada.setText(modelSer.getIndexOf(id_serie));
        //-------------------------------------------
        //Muestra los datos que regresa la consult mostrarSubserie
        DefaultComboBoxModel modelSub = new DefaultComboBoxModel(ConFav.mostrarSubserie(this.id_serie_a_guardar));
        //Le asigna el modelo y los registros al combobox cbxSerie
        cbxSubserie.setModel(modelSub);
        cbxSubserie.setVisible(true);
        //Asigna el numero que contiene id_serie al numero que se muestra en el modelo del combobox cbxserie
        cbxSubserie.setSelectedIndex(this.id_subserie);
        //    lblClasificacionAsignada.setText(modelSer.getIndexOf(id_serie));

        if (id_subserie == 0) {
            Serie ser = (Serie) this.cbxSerie.getSelectedItem();
            this.lblClasificacionAsignada.setText(ser.getNombre());
        } else {
            Subserie sub = (Subserie) this.cbxSubserie.getSelectedItem();
            this.lblClasificacionAsignada.setText(sub.getNombre());
        }

        //asignar el destinatario por default
        this.txtDestinatario.setText(destinatario);

        this.txtAsunto.setText(asunto);
        this.jrbNotice.isSelected();
        if (envio == 1) {
            this.jrbNotice.setSelected(true);
            this.jrbOficio.setSelected(false);
            this.jrbOficio.setVisible(false);

        } else {
            //this.cbxTipoEnvio.setVisible(true);
            this.jrbOficio.setSelected(true);
            this.jrbNotice.setSelected(false);
            this.jrbNotice.setVisible(false);
        ...
        //this.envio = 1;
        //ConsultasFavorito ConFav = new ConsultasFavorito();
        DefaultComboBoxModel modelEnvio = new DefaultComboBoxModel(ConFav.mostrarEnvio(envio));
        this.cbxTipoEnvio.setModel(modelEnvio);
        Envio env = (Envio) this.cbxTipoEnvio.getSelectedItem();
        System.out.println("TipoEnvio al precionar Notice" + this.cbxTipoEnvio.getSelectedIndex());
        this.lblTipoEnvioAsignado.setText(env.getNombre());
        this.lblTipoDocumentoAsignado.setText(ConFav.mostrarTipoDocumento(envio));
        int optionEnvioAsignado = env.getId();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblTipoEnvioAsignado)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFavorito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmFavorito().setVisible(true);
            }
        });
    }
