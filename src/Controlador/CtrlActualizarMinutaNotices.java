...
public class CtrlActualizarMinutaNotices implements ActionListener, MouseListener, KeyListener {

    private final ModeloActualizarMinutaNotices mod;
    private final ConsultasActualizarMinutaNotices modC;
    private final frmActualizarMinutaNotices frm;
    ...
    public CtrlActualizarMinutaNotices(ModeloActualizarMinutaNotices modActNt, ConsultasActualizarMinutaNotices modConActNt, frmActualizarMinutaNotices frmActNt, int idFuncionario) {
        this.mod = modActNt;
        this.modC = modConActNt;
        this.frm = frmActNt;
...
//        this.frm.btnCancelar.addActionListener(this);
        this.frm.jtActMinNt.addMouseListener(this);
...
//        this.frm.btnGuardarMod.addActionListener(this);
        ...
        this.frm.jtActMinNt.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        ConsultasActualizarMinutaNotices ConActNt = new ConsultasActualizarMinutaNotices();


        DefaultComboBoxModel modelDestino = new DefaultComboBoxModel(ConActNt.mostrarDestinatario());
        frm.cbxDestinatario.setModel(modelDestino);

        DefaultComboBoxModel modelSeccion = new DefaultComboBoxModel(ConActNt.mostrarSeccion());
        frm.cbxSeccion.setModel(modelSeccion);

        DefaultComboBoxModel modelSerie = new DefaultComboBoxModel(ConActNt.mostrarSerie());
        frm.cbxSerie.setModel(modelSerie);

        DefaultComboBoxModel modelSubserie = new DefaultComboBoxModel(ConActNt.mostrarSubserie());
        frm.cbxSubserie.setModel(modelSubserie);

        DefaultComboBoxModel modelTipoEnvio = new DefaultComboBoxModel(ConActNt.mostrarTipoEnvio());
...
//    }
    public void iniciar() {
        frm.setTitle("Actualizar Minuta Notice");
